...
!(function (n) {
    ...
    let a;
    let _;
    var s = (((u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u)
      && u.requirejs)
      || (u ? (n = u) : (u = {}),
      (g = {}),
      (m = {}),
      ...
      (r = function (e, t, n, s) {
          ...
          if (u == 'undefined' || u == 'function') {
              for (
                  ...
                  if ((r = (o = h(t[a], d)).f) === 'require') c[a] = f.require(e);
                  else if (r === 'exports') (c[a] = f.exports(e)), (l = !0);
                  else if (r === 'module') i = c[a] = f.module(e);
      ...
      (e = n = o = function (e, t, n, s, i) {
          if (typeof e === 'string') return f[e] ? f[e](t) : x(h(e, A(t)).f);
          if (!e.splice) {
    ...
    u.define('select2/utils', ['jquery'], (r) => {
        ...
        function c(e) {
            ...
            const n = e.prototype;
            const s = [];
            for (t in n) typeof n[t] === 'function' && t !== 'constructor' && s.push(t);
            return s;
        }
        ...
        (e.prototype.invoke = function (e, t) {
            for (let n = 0, s = e.length; n < s; n++) e[n].apply(this, t);
        }),
        (s.Observable = e),
        ...
        (s.hasScroll = function (e, t) {
            const n = r(t);
            const s = t.style.overflowX;
            const i = t.style.overflowY;
            return (
                (s !== i || (i !== 'hidden' && i !== 'visible'))
            && (s === 'scroll'
              || i === 'scroll'
        ...
        return (
            ...
            (s.GetData = function (e, t) {
                const n = s.GetUniqueElementId(e);
                return t
                    ? s.__cache[n] && s.__cache[n][t] != null
                        ? s.__cache[n][t]
                        : r(e).data(t)
                    : s.__cache[n];
            }),
            (s.RemoveData = function (e) {
                const t = s.GetUniqueElementId(e);
                s.__cache[t] != null && delete s.__cache[t],
            ...
            (s.copyNonInternalCssClasses = function (e, t) {
                var n = (n = e
                    .getAttribute('class')
                    .trim()
                    .split(/\s+/)).filter((e) => e.indexOf('select2-') === 0);
                var t = (t = t
                    .getAttribute('class')
                    .trim()
                    .split(/\s+/)).filter((e) => e.indexOf('select2-') !== 0);
    ...
    u.define('select2/results', ['jquery', './utils'], (d, p) => {
        ...
        return (
            ...
            (s.prototype.displayMessage = function (e) {
                ...
                const s = this.options.get('translations').get(e.message);
                n.append(t(s(e.args))),
            ...
            (s.prototype.highlightFirstItem = function () {
                ...
                (t.length > 0 ? t : e).first().trigger('mouseenter'),
                this.ensureHighlightVisible();
            }),
            (s.prototype.setClasses = function () {
                const t = this;
                this.data.current((e) => {
                    const s = e.map((e) => e.id.toString());
                    t.$results
                        .find('.select2-results__option--selectable')
                        .each(function () {
                            const e = d(this);
                            const t = p.GetData(this, 'data');
                            const n = `${t.id}`;
                            (t.element != null && t.element.selected)
                || (t.element == null && s.indexOf(n) > -1)
            ...
            (s.prototype.option = function (e) {
                ...
                let n;
                const s = { role: 'option' };
                let i = window.Element.prototype.matches
            || window.Element.prototype.msMatchesSelector
            || window.Element.prototype.webkitMatchesSelector;
                for (n in (((e.element != null && i.call(e.element, ':disabled'))
            ...
            (s.prototype.bind = function (t, e) {
                ...
                t.on('results:toggle', () => {
                    const e = i.getHighlightedResults();
                    e.length !== 0 && e.trigger('mouseup');
                }),
                t.on('results:select', () => {
                    let e;
                    const t = i.getHighlightedResults();
                    t.length !== 0
                ...
                t.on('results:previous', () => {
                    let e;
                    let t = i.getHighlightedResults();
                    let n = i.$results.find('.select2-results__option--selectable');
                    let s = n.index(t);
                    s <= 0
                || ((e = s - 1),
                t.length === 0 && (e = 0),
              ...
              && this.$results.on('mousewheel', (e) => {
                  ...
                  var n = i.$results.get(0).scrollHeight - t + e.deltaY;
                  var t = e.deltaY > 0 && t - e.deltaY <= 0;
                  var n = e.deltaY < 0 && n <= i.$results.height();
                  t
                      ? (i.$results.scrollTop(0),
                      e.preventDefault(),
                      e.stopPropagation())
            ...
            (s.prototype.template = function (e, t) {
                ...
                const s = this.options.get('escapeMarkup');
                var e = n(e, t);
                e == null
        ...
        (n, s, i) => {
            ...
            return (
                ...
                (r.prototype.render = function () {
                    ...
                    return (
                        (this._tabindex = 0),
                        s.GetData(this.$element[0], 'old-tabindex') != null
                ...
                (r.prototype.update = function (e) {
                    if ((this.clear(), e.length !== 0)) {
                        for (
                            ...
                            let o = this.display(i, r);
                            let a = `${n + c.generateChars(4)}-`;
                            i.id ? (a += i.id) : (a += c.generateChars(4)),
                            r
                                .find('.select2-selection__choice__display')
                                .append(o)
                                .attr('id', a);
                            let l = i.title || i.text;
                            l && r.attr('title', l);
    ...
    u.define('select2/selection/placeholder', [], () => {
        ...
        return (
            (e.prototype.normalizePlaceholder = function (e, t) {
                return (t = typeof t === 'string' ? { id: '', text: t } : t);
            }),
        ...
        (s, a, l) => {
            ...
            return (
                (e.prototype.render = function (e) {
                    const t = this.options.get('translations').get('search');
                    const n = s(
    ...
    u.define('select2/selection/selectionCss', ['../utils'], (n) => {
        ...
        return (
            (e.prototype.render = function (e) {
                const t = e.call(this);
                var e = this.options.get('selectionCssClass') || '';
                return (
                    e.indexOf(':all:') !== -1
              && ((e = e.replace(':all:', '')),
    ...
    u.define('select2/selection/eventRelay', ['jquery'], (o) => {
        ...
        return (
            (e.prototype.bind = function (e, t, n) {
                ...
                s.$element.trigger(n),
                r.indexOf(e) !== -1 && (t.prevented = n.isDefaultPrevented()));
                });
            }),
            e
        );
        ...
        (e, a, l) => {
            ...
            return (
                ...
                (n.prototype.select = function (i) {
                    ...
                    if (
                        ((i.selected = !0),
                        i.element != null && i.element.tagName.toLowerCase() === 'option')
                    ) {
                        return (
                ...
                (n.prototype.unselect = function (i) {
                    ...
                    if (this.$element.prop('multiple')) {
                        if (
                            ((i.selected = !1),
                            i.element != null
                  && i.element.tagName.toLowerCase() === 'option')
                        ) {
                            return (
        ...
        (e, t, c) => {
            ...
            return (
                ...
                (s.prototype.select = function (n) {
                    let e = this.$element
                        .find('option')
                        .filter((e, t) => t.value == n.id.toString());
        ...
        (e, t, r) => {
            ...
            return (
              ...
              && (typeof this._request.abort === 'function'
                && this._request.abort(),
              (this._request = null));
                    const i = r.extend({ type: 'GET' }, this.ajaxOptions);
                    function e() {
                        var e = i.transport(
                            i,
                            (e) => {
                ...
                c.term != null && c.page == null
                    ? e.call(this, c, function e(t, n) {
                        for (var s = t.results, i = 0; i < s.length; i++) {
                            const r = s[i];
                            const o = r.children != null && !e({ results: r.children }, !0);
                            if (
                                (r.text || '').toUpperCase()
                        === (c.term || '').toUpperCase()
                      || o
    ...
    u.define('select2/data/maximumSelectionLength', [], () => {
        ...
        return (
            ...
            (e.prototype._checkIfMaximumSelected = function (e, t) {
                ...
                this.current((e) => {
                    e = e != null ? e.length : 0;
                    n.maximumSelectionLength > 0 && e >= n.maximumSelectionLength
    ...
    u.define('select2/dropdown/search', ['jquery'], (r) => {
        ...
        return (
            (e.prototype.render = function (e) {
                const t = e.call(this);
                const n = this.options.get('translations').get('search');
                var e = r(
    ...
    u.define('select2/dropdown/hidePlaceholder', [], () => {
        ...
        return (
            ...
            (e.prototype.removePlaceholder = function (e, t) {
                for (var n = t.slice(0), s = t.length - 1; s >= 0; s--) {
                    const i = t[s];
    ...
    u.define('select2/dropdown/infiniteScroll', ['jquery'], (n) => {
        ...
        return (
            ...
            (e.prototype.loadMoreIfNeeded = function () {
                let e = n.contains(document.documentElement, this.$loadingMore[0]);
                !this.loading
            && e
    ...
    u.define('select2/dropdown/attachBody', ['jquery', '../utils'], (u, o) => {
        ...
        return (
            ...
            (e.prototype._attachPositioningHandler = function (e, t) {
                const n = this;
                const s = `scroll.select2.${t.id}`;
                const i = `resize.select2.${t.id}`;
                const r = `orientationchange.select2.${t.id}`;
                var t = this.$container.parents().filter(o.hasScroll);
                t.each(function () {
                ...
                t.on(s, function (e) {
                    const t = o.GetData(this, 'select2-scroll-position');
            ...
            (e.prototype._positionDropdown = function () {
                ...
                let s = null;
                let i = this.$container.offset();
                i.bottom = i.top + this.$container.outerHeight(!1);
                const r = { height: this.$container.outerHeight(!1) };
                (r.top = i.top), (r.bottom = i.top + r.height);
                const o = this.$dropdown.outerHeight(!1);
                var a = e.scrollTop();
                var l = e.scrollTop() + e.height();
                const c = a < i.top - o;
                var e = l > i.bottom + o;
                var a = { left: i.left, top: r.bottom };
                var l = this.$dropdownParent;
                l.css('position') === 'static' && (l = l.offsetParent());
                i = { top: 0, left: 0 };
    ...
    u.define('select2/dropdown/selectOnClose', ['../utils'], (s) => {
        ...
        return (
            ...
            (e.prototype._handleSelectOnClose = function (e, t) {
                ...
                n.length < 1
            || ((n = s.GetData(n[0], 'data')).element != null
              && n.element.selected)
    ...
    u.define('select2/dropdown/tagsSearchHighlight', ['../utils'], (s) => {
        ...
        return (
            (e.prototype.highlightFirstItem = function (e) {
                ...
                if (t.length > 0) {
                    const n = t.first();
                    var t = s.GetData(n[0], 'data').element;
                    if (
                        t
              && t.getAttribute
              && t.getAttribute('data-select2-tag') === 'true'
    ...
    u.define('select2/i18n/en', [], () => ({
        ...
        inputTooLong: function (e) {
            ...
            var e = `Please delete ${t} character`;
            return t != 1 && (e += 's'), e;
        },
            ...
            return (
              ...
              (e.tokenSeparators == null && e.tokenizer == null)
                        ...
                        matcher: function e(t, n) {
                            ...
                            if (n.children && n.children.length > 0) {
                                for (
                                    ...
                                    i >= 0;
                                    i--
                                ) e(t, n.children[i]) == null && s.children.splice(i, 1);
                                return s.children.length > 0 ? s : e(t, s);
                            }
                            const r = a(n.text).toUpperCase();
                            const o = a(t.term).toUpperCase();
                            return r.indexOf(o) > -1 ? n : null;
                        },
                ...
                (n.prototype.applyFromElement = function (e, t) {
                    const n = e.language;
                    const s = this.defaults.language;
                    const i = t.prop('lang');
                    var t = t.closest('[lang]').prop('lang');
                    var t = Array.prototype.concat.call(
            ...
            return (
              ...
              && (this.options.multiple = e.prop('multiple')),
                ...
                (n[r.replace(/-([a-z])/g, s)] = o));
                    ...
                    c.fn.jquery
              && c.fn.jquery.substr(0, 2) == '1.'
              && e[0].dataset
              && (n = c.extend(!0, {}, e[0].dataset, n));
                    let a;
                    let l = c.extend(!0, {}, u.GetData(e[0]), n);
            ...
            return (
                ...
                (o.prototype._resolveWidth = function (e, t) {
                    ...
                    if (t == 'resolve') {
                        ...
                        return s != null ? s : this._resolveWidth(e, 'element');
                    }
                    if (t == 'element') {
                        s = e.outerWidth(!1);
                    ...
                    for (let i = e.split(';'), r = 0, o = i.length; r < o; r += 1) {
                        const a = i[r].replace(/\s/g, '').match(n);
                        if (a !== null && a.length >= 1) return a[1];
                    }
                    return null;
                }),
                ...
                (o.prototype._isChangeMutation = function (e) {
                    ...
                    if (e.addedNodes && e.addedNodes.length > 0) {
                        for (let n = 0; n < e.addedNodes.length; n++) if (e.addedNodes[n].selected) return !0;
                    }
                    else {
                        if (e.removedNodes && e.removedNodes.length > 0) return !0;
                        if (Array.isArray(e)) return e.some((e) => t._isChangeMutation(e));
                    }
                    return !1;
                }),
        ...
        (i, e, r, t, o) => {
            ...
            (i.fn.select2 = function (t) {
                ...
                return (
                    ...
                    a.indexOf(t) > -1 ? this : n
                );
            })),
                i.fn.select2.defaults == null && (i.fn.select2.defaults = t),
                r
            );
        },
    ),
    ...
    function l(e, t) {
        ...
        if ((p || f) && h) {
            for (c = (n = e.split('/')).length; c > 0; --c) {
                if (((s = n.slice(0, c).join('/')), p)) {
                    for (u = p.length; u > 0; --u) {
