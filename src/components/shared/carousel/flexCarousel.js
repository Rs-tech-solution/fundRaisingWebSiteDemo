...
import styles from "./flexCarousel.module.scss";

const FlexCarousel = forwardRef(
  (
    {
      slidesToShow = 1,
      gap = 16,
    ...
    }, [slidesToShow, gap, partialVisible, partialVisibilityGutter, sliderRef]);
    ...
    }, [autoplay, autoplayInterval, currentSlide, items.length, goToSlide]);
            ...
            {items.map((child, index) => (
              <div
                className={`${styles.slide} ${
                  child && child.props ? child.props.slideClass : ""
                }`}
