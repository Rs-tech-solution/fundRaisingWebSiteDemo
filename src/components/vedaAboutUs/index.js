...
import styles from "./vedaAboutUs.module.scss";
  ...
  return (
    <div className={styles.container}>
      ...
      <p>
        ...
        scriptures is accessible to all who seek it, and the sanctity of life is
        honoured in our Goshalas and through the noble act of Annadaan.
      </p>
      ...
      <p>
        ...
        spreading awareness, your support is invaluable.
      </p>
      <p>
        Let us walk hand in hand to nurture the soul of Sanatana Dharma for a
        brighter, compassionate world.
      </p>
    </div>
  );
};

export default VedaAboutUs;
